...
import { usePaginatedResource } from '@/hooks/useResource';
import useMemberManagement from '@/hooks/useMemberManagement';

const Members = () => {
  // Use paginated resource for members
  const {
    data: members,
    ...
    handleSearch: searchMembers,
    remove: deleteMember,
    refresh: refreshMembers
  } = usePaginatedResource(tripMemberApi, { 
    idField: 'member_id',
    pageSize: 10
  });
  ...
  // Update member management with pagination
  const [selectedMemberState, setSelectedMemberState] = useState(null);

  // Event handlers for search and operations
  ...
  const handleDeleteMember = async (member) => {
    try {
      ...
      refreshMembers(pagination.currentPage, pagination.pageSize);
    } catch (error) {
