...
export const routes = {
  ...
  manageUsers: {
    ...
    tabs: [
      ...
      { id: "user-groups", name: "Organisations", displayName: "Organisations", path: "/manage-users/user-groups", group: "Organisations" },
      { id: "org-programs", name: "Insurance Plans", displayName: "Insurance Plans", path: "/manage-users/org-programs", group: "Organisations", hidden: true },
      { id: "providers", name: "Service Providers", displayName: "Service Providers", path: "/manage-users/providers", group: "Organisations", hidden: true },
