...
export const routes = {
  ...
  manageUsers: {
    ...
    tabs: [
      ...
      { id: "user-groups", name: "Organisations", path: "/manage-users/user-groups", group: "Business Entities" },
      { id: "org-programs", name: "Programs", path: "/manage-users/org-programs", group: "Business Entities" },
      { id: "providers", name: "Providers", path: "/manage-users/providers", group: "Business Entities" },
