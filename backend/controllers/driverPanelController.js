...
exports.getDriverTripLeg = async (req, res) => {
  try {
...
exports.updateTripLegStatus = async (req, res) => {
  try {
...
exports.updateTripLegOdometer = async (req, res) => {
  try {
    const { legId } = req.params;
...
exports.updateDriverSignature = async (req, res) => {
  try {
    const { driverId } = req.params;
...
exports.updateTripMemberSignature = async (req, res) => {
  try {
